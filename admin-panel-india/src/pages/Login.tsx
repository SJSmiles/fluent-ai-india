        ...
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Segoe UI', sans-serif" }}>
            ...
            <div style={{ flex: '0 0 50%', width: '50%', background: '#f0f2f8', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 64px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '60px' }}>
                    <div style={{ width: '32px', height: '32px', background: '#3b5bdb', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', fontWeight: 800, color: 'white' }}>F</div>
                ...
                <div>
                    ...
                    <p style={{ fontSize: '16px', color: '#6b7280', lineHeight: 1.65, marginBottom: '32px' }}>
                        Experience seamless communication with Fluent, the AI phone assistant that sounds human-like. Automate calls and provide customers with natural conversations, while Fluent handles routine tasks, freeing your time for what matters most.
                    </p>
            ...
            {/* RIGHT — exactly 50% */}
            <div style={{ flex: '0 0 50%', width: '50%', background: '#ffffff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '48px 64px 36px', boxShadow: '-4px 0 40px rgba(0,0,0,0.06)' }}>
                <div>
