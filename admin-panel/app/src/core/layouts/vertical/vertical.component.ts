...
import { getSidebarSize } from 'app/src/store/layouts/layout-selector';
import { RootReducerState } from 'app/src/store';
...
export class VerticalComponent implements OnInit {
  ...
  private handlePreloader(route: any) {
    ...
    // Check if preloader element exists before trying to modify it
    if (!preloader) {
